...
import unknowndomain.engine.UnknownDomain;
...
public abstract class GameBase implements Game {
    ...
    protected void registerStage() {
        ...
        for (Registry.Type<?> tp : Arrays.asList(Registry.Type.of("action", Action.class), Registry.Type.of("block", Block.class), Registry.Type.of("item", Item.class),
