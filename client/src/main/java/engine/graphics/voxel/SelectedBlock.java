...
public class SelectedBlock implements Drawable {
    ...
    public SelectedBlock() {
        ...
        buf.pos(minX, minY, minZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(maxX, minY, minZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(minX, minY, minZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(minX, maxY, minZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(minX, minY, minZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(minX, minY, maxZ).color(Color.WHITE).tex(0, 0).endVertex();

        buf.pos(minX, maxY, maxZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(minX, maxY, minZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(minX, maxY, maxZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(minX, minY, maxZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(minX, maxY, maxZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(maxX, maxY, maxZ).color(Color.WHITE).tex(0, 0).endVertex();

        buf.pos(maxX, maxY, minZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(minX, maxY, minZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(maxX, maxY, minZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(maxX, minY, minZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(maxX, maxY, minZ).color(Color.WHITE).tex(0, 0).endVertex();
        ...
        buf.pos(maxX, minY, maxZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(minX, minY, maxZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(maxX, minY, maxZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(maxX, maxY, maxZ).color(Color.WHITE).tex(0, 0).endVertex();
        buf.pos(maxX, minY, maxZ).color(Color.WHITE).tex(0, 0).endVertex();
