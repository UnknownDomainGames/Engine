...
public class RendererSkybox extends RendererShaderProgramCommon {

    protected int u_Projection;
    protected int u_View;
    protected int u_Model;
    private Texture2D texsky;
    ...
    public void init(ResourceManager resourceManager) throws IOException {
        ...
        texsky = new Texture2D(ImageIO.read(resourceManager.load(new ResourcePath("", "unknowndomain/textures/misc/skybox_steel.png")).open()));
        texsky.loadImage();
        useProgram();
        ...
        glMesh = new MeshToGLNode().convert(new Mesh(
                new float[]{
                        128,128,-128,
                        128,128,128,
                        128,-128,-128,
