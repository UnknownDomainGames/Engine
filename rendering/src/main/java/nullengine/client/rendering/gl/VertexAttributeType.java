...
enum VertexAttributeType {
    BUFFER(GLVertexBuffer.class, false) {
        @Override
        public void apply(int index, VertexElement element, Object value) {
            ((GLVertexBuffer) value).bind();
            GLHelper.enableVertexElement(element, index);
        }

        @Override
        public void applyDefault(int index, VertexElement element) {
    ...
    public abstract void apply(int index, VertexElement element, Object value);

    public abstract void applyDefault(int index, VertexElement element);
