...
public class ItemImpl implements Item,Runnable {
	private int maxStackAmount=100; //Max Amount can stack,you can set it
	private String name;
	private int hp;
	private int harm;
	private boolean canBeDestroy;

	private ItemImpl(String name,int hp,int harm,boolean canBeDestroy){
		this.name=name;
		this.hp=hp;
		this.harm=harm;
	...
	public class ItemBuilder{
		...
		public ItemImpl build(){
			return new ItemImpl(name,hp,harm,canBeDestroy);
		}
	}
	@Override
