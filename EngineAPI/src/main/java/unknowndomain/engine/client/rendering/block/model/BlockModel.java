...
public class BlockModel implements BlockMeshGenerator {
    ...
    public void renderModelQuad(BlockModelQuad modelQuad, BlockPos pos, GLBuffer buffer) {
        ...
        buffer.pos(modelQuad.vertexs[0], modelQuad.vertexs[1], modelQuad.vertexs[2]).color(1, 1, 1).uv(textureUV.getMinU(), textureUV.getMaxV()).normal(normal).endVertex(); // 1
        buffer.pos(modelQuad.vertexs[3], modelQuad.vertexs[4], modelQuad.vertexs[5]).color(1, 1, 1).uv(textureUV.getMaxU(), textureUV.getMaxV()).normal(normal).endVertex(); // 2
        buffer.pos(modelQuad.vertexs[6], modelQuad.vertexs[7], modelQuad.vertexs[8]).color(1, 1, 1).uv(textureUV.getMaxU(), textureUV.getMinV()).normal(normal).endVertex(); // 3

        buffer.pos(modelQuad.vertexs[0], modelQuad.vertexs[1], modelQuad.vertexs[2]).color(1, 1, 1).uv(textureUV.getMinU(), textureUV.getMaxV()).normal(normal1).endVertex(); // 1
