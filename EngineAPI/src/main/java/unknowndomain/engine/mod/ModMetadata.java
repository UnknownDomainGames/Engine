...
public class ModMetadata extends ModIdentifier {
    ...
    protected ModMetadata(String id, ComparableVersion version, String mainClass, String name, String description, String url, List<String> authors, String logoFile, List<ModDependencyEntry> dependencies, Map<String, String> properties) {
        super(id, version);
    ...
    public static class Builder {
        ...
        public ModMetadata build() {
            return new ModMetadata(id, version, mainClass, name, description, url, authors, logo, dependency, properties);
        }
    }
}
