 ...
 */
public class OpenSimplexNoiseSampler implements NoiseSampler {
    ...
    public OpenSimplexNoiseSampler(long seed) {
    ...
    public double sample(double x, double y) {
        return noise2_XBeforeY(x, y);
    }

    @Override
    public double sample(double x, double y, double z) {
        return noise3_XZBeforeY(x, y, z);
    }
