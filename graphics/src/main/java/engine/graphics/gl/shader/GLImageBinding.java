...
public class GLImageBinding implements ImageBinding {
    ...
    public void bind() {
        ...
        GL42.glBindImageTexture(unit, glTexture.getId(), 0, false, 0, canRead && canWrite ? GL42.GL_READ_WRITE : canRead ? GL42.GL_READ_ONLY : GL42.GL_WRITE_ONLY, GLColorFormat.valueOf(glTexture.getFormat()).internalFormat);
    }
}
