...
public class RectRenderer implements NodeRenderer<Rect> {
    ...
    public void render(Rect rect, Graphics graphics) {
        ...
        if (strokeWidth > 0) {
            ...
            graphics.pushClipRect(rect.getLayoutX() - strokeWidth, rect.getLayoutY() - strokeWidth, rect.getWidth() + strokeWidth * 2, rect.getHeight() + strokeWidth * 2);
            graphics.setColor(rect.getStrokeColor());
            graphics.fillRect(0, 0, rect.getWidth() + strokeWidth * 2, rect.getHeight() + strokeWidth * 2);
        }
